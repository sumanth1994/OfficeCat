...
@interface groupNewPostViewController ()

@end

@implementation groupNewPostViewController
...
- (void)viewDidLoad
{
    ...
    CLLocation *location = [[CLLocation alloc] initWithLatitude:grpPostLat longitude:grpPostLong];
    ...
    if([self.help isEqualToString:@"From Map"]){
        ...
        grpPostLat = mapview.userLocation.coordinate.latitude;
        grpPostLong = mapview.userLocation.coordinate.longitude;
    }
...
-(void)mapView:(MKMapView *)mapView didUpdateUserLocation:(MKUserLocation *)userLocation
{
    ...
    grpPostLat = userLocation.coordinate.latitude;
    grpPostLong = userLocation.coordinate.longitude;
        ...
        case 2: {
            switch (buttonIndex) {
                ...
                case 3:
                {
                    ...
                    viewController.postLat = [NSString stringWithFormat:@"%f",grpPostLat];
                    viewController.postLong = [NSString stringWithFormat:@"%f",grpPostLong];
                    viewController.grpID = _grpID;
                    viewController.from = @"Group";
